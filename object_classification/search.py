...
def main(model_seed=0, data_seed=0, batchsize=25, max_epoch=100, patience=20, tot_acq=300, log_dir='logs',
         use_gpus='all', workers_per_gpu=2, anneal_factor=0.1, num_sa_samples=40000, num_greedy_samples=5000):
        run_args = Namespace(model_seed=model_seed, data_seed=data_seed,
                             batchsize=batchsize, max_epoch=max_epoch, patience=patience, tot_acq=tot_acq,
                             log_dir=log_dir, use_gpus=use_gpus, workers_per_gpu=workers_per_gpu,
                             anneal_factor=anneal_factor, num_sa_samples=num_sa_samples, num_greedy_samples=num_greedy_samples)
